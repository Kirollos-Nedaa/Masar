...
namespace Masar.Infrastructure.Migrations
{
    ...
    [Migration("20260520193719_CandidateProfileAddResumeDate")]
    partial class CandidateProfileAddResumeDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Masar.Domain.Models.CandidateProfile", b =>
                {
                    ...
                    b.Property<string>("ResumeUploadedAt")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Masar.Domain.Models.Education", b =>
                {
                    ...
                    b.Property<DateOnly>("ExpectedGraduation")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Masar.Domain.Models.ApplicationAnswer", b =>
                {
                    ...
                    b.HasOne("Masar.Domain.Models.JobQuestion", "JobQuestion")
                        .WithMany()
